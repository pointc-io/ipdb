...
func (t *RedconTransport) AppendEntriesPipeline(id raft.ServerID, target raft.ServerAddress) (raft.AppendPipeline, error) {
...
func (t *RedconTransport) AppendEntries(id raft.ServerID, target raft.ServerAddress, args *raft.AppendEntriesRequest, resp *raft.AppendEntriesResponse) error {
...
func (t *RedconTransport) RequestVote(id raft.ServerID, target raft.ServerAddress, args *raft.RequestVoteRequest, resp *raft.RequestVoteResponse) error {
	data, _ := json.Marshal(args)
	val, _, err := Do(string(target), nil, []byte("raftrequestvote"), data)
	if err != nil {
		return err
	}
...
func (t *RedconTransport) LocalAddr() raft.ServerAddress { return raft.ServerAddress(t.addr) }

// EncodePeer implmenents the Transport interface.
func (t *RedconTransport) EncodePeer(id raft.ServerID, peer raft.ServerAddress) []byte { return []byte(peer) }

// DecodePeer implmenents the Transport interface.
func (t *RedconTransport) DecodePeer(peer []byte) raft.ServerAddress { return raft.ServerAddress(peer) }
